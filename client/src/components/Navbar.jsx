          ...
          <div className="hidden md:flex items-center space-x-1">
            {navLinks.map((link) => (
              <Link
                ...
                className="px-4 py-2 rounded-lg text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-900/20 cursor-pointer transition-all duration-300 font-medium text-sm"
              >
                {link.name}
              </Link>
            ))}
            ...
            <div className="px-4 py-4 space-y-2">
              {navLinks.map((link) => (
                <Link
                  ...
                  className="block px-4 py-3 rounded-lg text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-primary-50 dark:hover:bg-primary-900/20 cursor-pointer transition-all duration-300 font-medium"
                >
                  {link.name}
                </Link>
              ))}
